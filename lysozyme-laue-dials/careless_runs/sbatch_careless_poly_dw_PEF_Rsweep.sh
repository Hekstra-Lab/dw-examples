...
#SBATCH -p gpu_test,seas_gpu,gpu,gpu_requeue #gpu_test # partition (queue)
...
INPUT_MTZS=(
    ../unmerged_mtzs/integrated_NaI_3_04_frame_0001_0720_plus.mtz
    ../unmerged_mtzs/integrated_NaI_3_04_frame_0001_0720_minus.mtz
)
