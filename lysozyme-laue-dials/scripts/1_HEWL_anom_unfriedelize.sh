...
for R in 0.98438; do  # 0.00000 0.50000 0.75000 0.87500 0.93750 0.96875 0.98438 0.99219 0.99609 0.99805 0.99902 0.99951 0.99976 0.99990 neg1; do
	...
	REFINE=../phenix_poly_dw_mlp32_PEF_R${R}_0720_dmin1pt8
	mkdir ${REFINE}
