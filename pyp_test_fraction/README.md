...
This folder contains instructions and scripts for processing a time-resolved photactive yellow protein (PYP) dataset. The example works as previously, but conducted on a small fraction of the data for semi-independent optimization of the double-Wilson $r$. Here, we
